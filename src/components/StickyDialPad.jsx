...
const StickyDialPad = () => {
  ...
  return (
    <div className="sticky-contact-buttons">
      {/* WhatsApp Button */}
      <div className="contact-button whatsapp-button" onClick={handleWhatsApp}>
        <svg 
      ...
      {/* Phone Button */}
      <div className="contact-button phone-button" onClick={handleCall}>
        <svg 
